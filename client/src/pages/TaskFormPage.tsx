...
export function TaskFormPage() {
  ...
  useEffect(() => {
    ...
    api.getTask(id).then(({ task: data }) => {
      ...
      setSelectedAssignees(t.task_assignees?.map((a: any) => a.user_id) || [])
      setLoading(false)
    })
  }, [id])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      due_date: dueDate || null, assignee_ids: selectedAssignees,
    }
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h1 className="mb-4 text-xl font-bold text-gray-900 dark:text-white lg:mb-6 lg:text-2xl">
